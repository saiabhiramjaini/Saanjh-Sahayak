...
exports.getById = exports.getAllDoctors = exports.signin = exports.signup = void 0;
...
const signup = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingCaretaker = yield db_1.db
            ...
            .where((0, drizzle_orm_1.eq)(schema_1.doctorsTable.email, email))
            .execute();
...
const getAllDoctors = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const doctors = yield db_1.db
            .select({
            id: schema_1.doctorsTable.id,
            username: schema_1.doctorsTable.username,
            email: schema_1.doctorsTable.email,
            specialization: schema_1.doctorsTable.specialization,
        })
            .from(schema_1.doctorsTable)
            .execute();
        return res.status(200).json({
